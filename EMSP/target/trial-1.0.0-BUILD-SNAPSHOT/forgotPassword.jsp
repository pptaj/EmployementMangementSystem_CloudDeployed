...
<head>
    ...
    <title>EMS - Password Reset</title>
...
<div class="login">
    <form action="forgotpassword.htm" commandName="person" method="POST">
        ...
        <div>
            ...
            <div>
                <input type="submit" value="Submit Request" id="submitButton"/>
            </div>
            <div>
                <a href="testJSP.jsp">HOME PAGE</a>
            </div>
        </div>
    </form>
</div>
